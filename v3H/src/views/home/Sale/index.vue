...
let saleStoreData = reactive({
    title: '旅游景点预定额排名',
    data: [
        { id: 1, name: '泰山', count: 1265656, flag: true },
        { id: 2, name: '黄鹤楼', count: 1022356, flag: true },
        { id: 3, name: '少林寺', count: 965321, flag: true },
        { id: 4, name: '岳阳楼', count: 895561, flag: false },
        { id: 5, name: '东方明珠塔', count: 765321, flag: false },
        { id: 6, name: '洞庭湖', count: 423513, flag: false },
        { id: 7, name: '故宫', count: 98622, flag: false },
    ]
})
